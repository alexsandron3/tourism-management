...
class Passeio extends Component {
  ...
  sendData = async () => {
    ...
    const {
      ...
      method: method,
      url: `https://fabiopasseios.com.br/ap/Projetos/SistemaFabio-2.0/api/passeio.php`,
  ...
  fetchPasseio = async () => {
    ...
    if (id) {
      const {
        ...
        `https://fabiopasseios.com.br/ap/Projetos/SistemaFabio-2.0/api/passeio.php?id=${id}`
      );
